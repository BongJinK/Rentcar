...
<body>
	<h2> Bong Car </h2>
	<section>
		<form method="post" action="../servise">
			...
			<table border="1">
				<tbody>
					...
					<tr>
						...
						<td><input type="password" id="password" name="password"
							maxlength="15" placeholder="비밀번호"></td>
					</tr>
					<tr>
						<th>비밀번호 재확인</th>
						<td><input type="password" id="password_check"
							name="password_check" maxlength="15" placeholder="비밀번호 확인"></td>
					</tr>
					<tr>
						<th>휴대전화</th>
					...
					<tr>
						...
						<td><input type="text" id="driver_code" name="driver_code"
							pattern="[0-9]{12}" maxlength="12" placeholder="123456789123"></td>
					</tr>
					<tr>
						<th>주소</th>
						<td>
				...
				<input type="button" id="regi_button" value="가입하기" onclick="checkValues(form)">
		</form>
	</section>
</body>
